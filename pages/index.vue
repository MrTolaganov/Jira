  ...
  <main class="pb-72">
    ...
    <section>
      <h1 class="text-4xl font-medium px-4">
        All from a single source of thruth
      </h1>
        ...
        <template #item="{ item }">
          <div class="flex justify-between items-center gap-6 mt-8">
            <div class="w-[40%]">
              ...
              <div
                class="py-4 mt-12 rounded-r-full flex flex-col space-y-2 bg-gradient-to-t from-white dark:from-black to-blue-500 dark:to-blue-800"
              >
                <Icon name="mingcute:quote-left-fill" class="text-7xl" />
    ...
    <section>
      ...
      <div class="flex items-center justify-between max-w-xl mx-auto mt-4">
        ...
        >
          <Icon name="material-symbols:linked-services" class="text-4xl" />
        </div>
      </div>
          ...
          <div v-for="(template, index) in templates" :key="index">
            <div class="flex flex-col mt-4">
              ...
              >
                ...
                >
                  <NuxtImg :src="template.image" class="w-12" />
                </div>
                <div class="flex flex-col space-y-2">
                  <h2 class="font-medium text-xl">{{ template.name }}</h2>
                  <div
